...
END_EMPH="\033[0m"
ABOUT="Generates a public/private RSA keypair in PEM format for use with IPSec \
for IPv6 in SocialVPN. The public key it generates can be given to your \
friends, and the private key can be kept to your self. Together, these can be \
used to verify your identity and to initialize an encrypted connection."
